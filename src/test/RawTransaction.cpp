...
BOOST_AUTO_TEST_CASE(GetRawTransactionVerbose) {
	...
	BOOST_REQUIRE_NO_THROW(response = fx.lux.getrawtransaction(txid,1));
...
BOOST_AUTO_TEST_CASE(DecodeRawTransaction) {
	...
	std::string rawHexTx =
			"729ef39f06e17124cfdcdb77c1373f889714fc7b073b2f772ac58b39baac7f"
	...
	BOOST_REQUIRE_NO_THROW(response = fx.lux.decoderawtransaction(rawHexTx));
...
BOOST_AUTO_TEST_CASE(SendRawTransaction) {
	...
	try{
		fx.lux.sendrawtransaction(param);
...
BOOST_AUTO_TEST_CASE(CreateRawTransaction) {
	...
	txout_t tmp1 = {"729ef39f06e17124cfdcdb77c1373f889714fc7b073b2f772ac58b39baac7f68", 1};

	std::vector<txout_t> param1;
	std::map<std::string,double> param2 = {{"LUF9sQV6ECbvVpYG8M1TugxCCfWUhHY6yM", 0.0001}};
	param1.push_back(tmp1);

	std::string response;
	std::string expected =
			"729ef39f06e17124cfdcdb77c1373f889714fc7b073b2f772ac58b39baac7f69"
			"94a339cdf320100000000ffffffff0110270000000000001976a9148dd50234"
			"78a002a1d3551445c3479f6f6ae611ad88ac00000000";

	BOOST_REQUIRE_NO_THROW(response = fx.lux.createrawtransaction(param1, param2));
...
BOOST_AUTO_TEST_CASE(SignRawTransaction) {
	...
	signrawtxin_t tmp1;
	tmp1.txid = "729ef39f06e17124cfdcdb77c1373f889714fc7b073b2f772ac58b39baac7f68";
	tmp1.n = 1;
	...
	std::string param1 =
				...
				"729ef39f06e17124cfdcdb77c1373f889714fc7b073b2f772ac58b39baac7f6"
				"78a002a1d3551445c3479f6f6ae611ad88ac00000000";
	...
	BOOST_REQUIRE_NO_THROW(response = fx.lux.signrawtransaction(param1,param2,param3,"ALL"));
...
BOOST_AUTO_TEST_CASE(GetRawMempool) {
	...
	BOOST_REQUIRE_NO_THROW(response = fx.lux.getrawmempool());
...
BOOST_AUTO_TEST_CASE(GetRawChangeAddress) {
	...
	std::string response;
	BOOST_REQUIRE_NO_THROW(response = fx.lux.getrawchangeaddress());
