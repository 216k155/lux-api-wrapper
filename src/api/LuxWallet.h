...
public:
	/* === Constructors === */
	LuxAPI();
	LuxAPI(const std::string& user, const std::string& password, const std::string& host, int port);
	...
	std::string dumpprivkey(const std::string& luxaddress);
	void importprivkey(const std::string& luxprivkey);
	void importprivkey(const std::string& luxprivkey, const std::string& label, bool rescan = true);
	...
	validateaddress_t validateaddress(const std::string& luxaddress);

	void keypoolrefill();
	bool settxfee(double amount);

	std::string signmessage(const std::string& luxaddress, const std::string& message);
	bool verifymessage(const std::string& luxaddress, const std::string& signature, const std::string& message);
	...
	double getreceivedbyaddress(const std::string& luxaddress, int minconf = 1);
	...
	std::string getaccount(const std::string& luxaddress);
	...
	void setaccount(const std::string& luxaddress, const std::string& account);

	std::string sendtoaddress(const std::string& luxaddress, double amount);
	std::string sendtoaddress(const std::string& luxaddress, double amount, const std::string& comment, const std::string& comment_to);

	std::string sendfrom(const std::string& fromaccount, const std::string& toluxaddress, double amount);
	std::string sendfrom(const std::string& fromaccount, const std::string& toluxaddress, double amount, const std::string& comment, const std::string& comment_to, int minconf = 1);
